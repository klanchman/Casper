/* PrismJS 1.12.2
http://prismjs.com/download.html#themes=prism-solarizedlight&languages=markup+css+clike+javascript+c+bash+csharp+docker+fsharp+graphql+ini+json+makefile+objectivec+properties+jsx+typescript+scss+swift+tsx */
